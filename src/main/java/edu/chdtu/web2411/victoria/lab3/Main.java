package edu.chdtu.web2411.victoria.lab3;

import java.util.Scanner;

import edu.chdtu.web2411.victoria.lab3.models.HospitalState;
import edu.chdtu.web2411.victoria.lab3.services.HospitalService;
import edu.chdtu.web2411.victoria.lab3.utils.DataManager;
            ...
            while (running) {
                ...
                switch (choice) {
                    ...
                    case "2":
                        ...
                        break;
                    case "3":
                        System.out.print("ID: "); int pId = scanner.nextInt();
                        if (service.getPatientById(pId) != null) {
                            System.out.println("ID already exists.");
                            break;
                        }
                        System.out.print("Name: "); String pName = scanner.next();
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        System.out.print("ID: "); int dId = scanner.nextInt();
                        if (service.getDoctorById(dId) != null) {
                            System.out.println("ID already exists.");
                            break;
                        }
                        System.out.print("Name: "); String dName = scanner.next();
                        System.out.print("Specialization: "); String spec = scanner.next();
                        service.addDoctor(dId, dName, spec);
                        break;
                    case "6":
                        System.out.print("Doctor ID: "); int docId = scanner.nextInt();
                        System.out.print("Patient ID: "); int patId = scanner.nextInt();
                        scanner.nextLine();
                        System.out.print("Diagnosis/Notes: "); String diag = scanner.nextLine();
